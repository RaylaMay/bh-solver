# DW0 platform, licence and later owner decisions

Prepared: 2026-09-10. Updated: 2026-09-13.
Status: **P-01, QT LGPLv3 ROUTE, AND BH NON-COMMERCIAL LICENCE ADOPTED**.

The owner approved DW0 with the [recorded annotations](DW0_OWNER_DISPOSITION.md).
...
Owner decision, 2026-09-11: develop and release first on **macOS/arm64**, while
...
| Earlier alternative considered | Disposition after owner decision |
|---|---|
...
verify the chosen release/toolchain against the owner's matrix before adoption.
[Qt supported platforms](https://doc.qt.io/qt-6/supported-platforms.html).

**Disposition: owner approved**, with minimums deferred by explicit instruction.
...
Owner decision, 2026-09-11: **Qt/PySide under LGPLv3**, no commercial Qt licence
...
| Commercial Qt route | Excluded by the owner at this stage |
...
**Project policy impact:** the owner accepted ADR-010's scoped desktop-distribution
...
|---|---|---|
| P-02 | Reference PFD counts by equipment/ports/segments/labels/overlays; interaction workload, latency/frame targets, OS/GPU/display matrix | DW3 benchmark; no 4K/144-Hz or 10,000-item promise |
...
DW0 approval and P-01/L-01's route are recorded in the owner disposition.
