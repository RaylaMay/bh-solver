<!-- Frozen source snapshot; see provenance.json. -->
...
work. The intake inventory (source-repository reference: `evidence/dw6-handoff/intake.json`) identifies its bytes;
...
The executable reviewer package (source-repository reference: `../../handoffs/dw6/README.md`) is prepared before
...
Use the digest and command recorded in the preparation record (source-repository reference: `DW6_HANDOFF_RECORD.md`).
